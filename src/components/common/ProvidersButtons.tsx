...
// import { getTokenHandler } from "next-auth/jwt";
  ...
  return (
    <div className="mt-10">
      ...
      <div className="flex gap-4  justify-between ">
        <button
          className="rounded-[16px] shadow-[0px_18px_30px_0px_#4461f21c] p-5 border w-16"
          onClick={() => signIn("google")}
        >
          <Image
            alt="idenity provider"
            width="30"
            height="30"
            src={LogoGoogle}
          />
        ...
        <button
          ...
          className="rounded-[16px] shadow-[0px_18px_30px_0px_#4461f21c] w-16 p-5 border "
        >
